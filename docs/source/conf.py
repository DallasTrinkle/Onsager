...
# -*- coding: utf-8 -*-
#
# Onsager documentation build configuration file, created by
...
sys.path.insert(0, os.path.abspath('../../onsager'))
sys.path.insert(0, os.path.abspath('../..'))
...
project = 'Onsager'
copyright = '2017, Dallas R. Trinkle'
...
latex_documents = [
    (master_doc, 'Onsager.tex', 'Onsager Documentation',
     'Dallas R. Trinkle', 'manual'),
]
